...
const outputPath = path.join(root, "lib", "scores.ts");
...
console.log("R10: 0 scores publicados; no existe una composición oficial verificable para todas sus dimensiones.");
