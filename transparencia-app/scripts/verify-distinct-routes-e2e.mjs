...
async function runE2E() {
  ...
  assert(hasPublishedParliamentaryDiet(beckerContent), "La dieta de Becker debe estar publicada en el panel de costo");
  ...
  assert(hasPublishedParliamentaryDiet(kaiserContent, "2026-06"), "La dieta de Kaiser debe estar publicada con período y monto");
