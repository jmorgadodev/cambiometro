...
export const RUT_OFICIAL_POR_SERVICIO: Record<string, string> = {
  ...
  "min-rrhh": "60.301.000-3",
  "min-defensa": "60.201.000-4",
  ...
  "min-justicia": "60.601.000-0",
  "min-trabajo": "60.701.000-3",
  "min-mop": "61.202.000-0",
  "min-salud": "61.601.000-K",
  "min-minvu": "61.401.000-1",
  "min-agricultura": "61.301.000-0",
  "min-mineria": "61.701.000-3",
  "min-mtt": "61.203.000-7",
