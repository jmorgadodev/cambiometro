...
export const COALICION_POR_PARTIDO: Record<string, { coalicion: "Oficialismo" | "Oposición" | "Independientes"; pacto: string }> = {
  udi: { coalicion: "Oficialismo", pacto: "Chile Grande y Unido" },
  rn: { coalicion: "Oficialismo", pacto: "Chile Grande y Unido" },
  evopoli: { coalicion: "Oficialismo", pacto: "Chile Grande y Unido" },
  dem: { coalicion: "Oficialismo", pacto: "Chile Grande y Unido" },
  ama: { coalicion: "Oficialismo", pacto: "Chile Grande y Unido" },
  rep: { coalicion: "Oficialismo", pacto: "Cambio por Chile" },
  pnl: { coalicion: "Oficialismo", pacto: "Cambio por Chile" },
  psc: { coalicion: "Oficialismo", pacto: "Cambio por Chile" },
  pdg: { coalicion: "Oficialismo", pacto: "Partido de la Gente" },
  fa: { coalicion: "Oposición", pacto: "Unidad por Chile" },
  ps: { coalicion: "Oposición", pacto: "Unidad por Chile" },
  pc: { coalicion: "Oposición", pacto: "Unidad por Chile" },
  ppd: { coalicion: "Oposición", pacto: "Unidad por Chile" },
  pdc: { coalicion: "Oposición", pacto: "Unidad por Chile" },
  pl: { coalicion: "Oposición", pacto: "Unidad por Chile" },
  pr: { coalicion: "Oposición", pacto: "Unidad por Chile" },
  frvs: { coalicion: "Oposición", pacto: "Verdes, Regionalistas y Humanistas" },
