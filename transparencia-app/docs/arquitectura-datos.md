...
* **Límites del publicador:** el publicador archiva objetos fríos al 80 % y bloquea crecimiento al 95 % para conservar un margen operativo; es una protección del proyecto, no un límite impuesto por Cloudflare.
